 ...
 */
package se.trixon.filebydate.actions;
...
@ActionID(
        category = "Help",
        id = "se.trixon.filebydate.actions.AboutAction"
)
public final class AboutAction implements ActionListener {

    @Override
    public void actionPerformed(ActionEvent e) {
        var aboutModel = new AboutModel(SystemHelper.getBundle(Filebydate.class, "about"), SystemHelper.getResourceAsImageIcon(Filebydate.class, "logo.png"));
