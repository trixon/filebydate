...
//        alert.initOwner(mStage);
    ...
    private void createUI() {
        ...
        var leftBorderPane = new BorderPane(mListView);
        leftBorderPane.setBottom(mPreviewPanel);
        mBorderPane.setLeft(leftBorderPane);

        mSplitPane = new SplitPane(leftBorderPane, mProgressPanel);
...
//            mRoot.setCenter(mListView);
        ...
        mLogAction = new Action(Dict.OUTPUT.toString(), (ActionEvent event) -> {
            ...
            mBorderPane.setCenter(mProgressPanel);
        });
